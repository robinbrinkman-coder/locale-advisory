        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-8">
          <div className="md:col-span-1 lg:col-span-4 text-center">
            ...
            <p className="opacity-70 leading-relaxed">
              We represent tenants only. No dual agency. No conflicts. Just smart advice aligned 
              with your interests.
            </p>
          </div>
          <div className="md:col-span-1 lg:col-span-4 text-center">
            ...
            <p className="opacity-70 leading-relaxed">
              Every recommendation is backed by data — market comparables, AI insights, and rigorous 
              financial modeling.
            </p>
          </div>
          <div className="md:col-span-1 lg:col-span-4 text-center">
            ...
            <p className="opacity-70 leading-relaxed">
              We think beyond the lease. Workplace strategy, team dynamics, and cultural fit all 
              factor into our approach.
            </p>
          </div>
        </div>
      </section>
